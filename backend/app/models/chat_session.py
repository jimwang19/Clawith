...
class ChatSession(Base):
    ...
    # DingTalk (and other channel) group session webhook URL — persisted so it survives backend restarts
    channel_webhook_url: Mapped[str | None] = mapped_column(String(500), nullable=True)
